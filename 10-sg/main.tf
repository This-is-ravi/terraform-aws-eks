...
#bastion accepting connections from public(companies elastic ip) 
...
# Ingress ALB accepting traffic on 443 as https
...
# Ingress ALB accepting traffic on 80 as http
...
# nodes should accept traffic from ingress
resource "aws_security_group_rule" "node_ingress" {
  type              = "ingress"
  from_port         = 30000 #ephemeral range
  to_port           = 32768
  protocol          = "TCP" # All traffic
