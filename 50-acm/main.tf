...
resource "aws_acm_certificate" "expense" {  #this wil create the certificate for my domain
  domain_name       = "*.csvdaws78s.online"
...
# after creating certif , it wil update the records into my domain
